...
import com.bhaskar.corvasnotes.Modal.Circle;
import com.bhaskar.corvasnotes.Modal.InputText;
import com.bhaskar.corvasnotes.Modal.Oval;
import com.bhaskar.corvasnotes.Modal.PathStore;
import com.bhaskar.corvasnotes.Modal.Rectangle;
import com.bhaskar.corvasnotes.Modal.Shape;
...
public class DrawingCanvas extends View {
    ...
    public void initialize() {
        ...
        changeFillStyle(Constant.PAINT_STYLE_STROKE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (getCurrentOperation() == Constant.OPERATION_DRAW_PENCIL) {
            canvas.drawPath(mBrushPath, mBrushPaint);
        } else if (getCurrentOperation() == Constant.OPERATION_ERASE) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (touchEvent) {
            case MotionEvent.ACTION_DOWN:
                if (mCurrentOperation == Constant.OPERATION_DRAW_PENCIL || mCurrentOperation == Constant.OPERATION_ERASE) {
                    mBrushPath.moveTo(xPos, yPos);
                    mBrushPath.lineTo(xPos, yPos);
                }
//                else if (mCurrentOperation == Constant.OPERATION_DRAW_CIRCLE) {
//                    mShapeList.add(new Circle(xPos, yPos, mCircleRadius, mBrushPaint.getColor()));
//                    setCurrentOperation(Constant.OPERATION_NO_OPERATION);
//                } else if (mCurrentOperation == Constant.OPERATION_DRAW_RECTANGLE) {
...
//                    setCurrentOperation(Constant.OPERATION_NO_OPERATION);
//                } else if (mCurrentOperation == Constant.OPERATION_DRAW_OVAL) {
...
//                            mBrushPaint.getColor()));
//                    setCurrentOperation(Constant.OPERATION_NO_OPERATION);
//                } else if (mCurrentOperation == Constant.OPERATION_INSERT_TEXT) {
...
//                }
            ...
            case MotionEvent.ACTION_MOVE:
                if (mCurrentOperation == Constant.OPERATION_DRAW_PENCIL || mCurrentOperation == Constant.OPERATION_ERASE) {
                    mBrushPath.lineTo(xPos, yPos);
                } else if (mCurrentOperation == Constant.OPERATION_MOVE_VIEW) {
            ...
            case MotionEvent.ACTION_UP:
                if (mCurrentOperation == Constant.OPERATION_DRAW_PENCIL) {
                    mShapeList.add(new PathStore(mBrushPath, mBrushPaint.getColor(), (int) mBrushPaint.getStrokeWidth()));
                    mBrushPath = new Path();
                } else if (mCurrentOperation == Constant.OPERATION_ERASE) {
    ...
    public void changeFillStyle(int style) {
        switch (style) {
            case Constant.PAINT_STYLE_FILL:
                mBrushPaint.setStyle(Paint.Style.FILL);
                break;
            case Constant.PAINT_STYLE_STROKE:
    ...
    public void setCurrentOperation(int operation) {
        if (operation == Constant.OPERATION_DRAW_PENCIL) {
            changeFillStyle(Constant.PAINT_STYLE_STROKE);
        }
...
//    public void redoPreviousOperation() {
//        if (mShapeList != null && mShapeList.size() != 0) {
//            mShapeList.remove(mShapeList.size() - 1);
//        }else if (mShapeList == null || mShapeList.size() == 0){
//            mCanvasBackground =null;
            ...
            if (mShapeList != null && mShapeList.size() > 0) {
                ...
                if (obj instanceof Circle) {
                    ...
                    if (isPointInCircle(xTouchPos, yTouchPos, cir)) {
                        ...
                        mCurrentOperation = Constant.OPERATION_MOVE_VIEW;
...
//                        mVibrator.vibrate(200);
            ...
            if (mShapeList != null && mShapeList.size() > 0) {
                ...
                if (obj instanceof Circle) {
                    ...
                    if (isPointInCircle(xTouchPos, yTouchPos, cir)) {
                        ...
                        mCurrentOperation = Constant.OPERATION_FILL_VIEW;
                    }
                } else if (obj instanceof Rectangle) {
                    Rectangle rect = (Rectangle) obj;
                    if (isPointInRectangle(xTouchPos, yTouchPos, rect)) {
    ...
    public void applyColorToView() {
        if (mCurrentOperation == Constant.OPERATION_FILL_VIEW) {
            Object obj = mShapeList.get(mShapeList.size() - 1);
            if (obj instanceof Circle) {
            ...
            invalidate();
            mCurrentOperation = Constant.OPERATION_NO_OPERATION;
        }
    }
