...
import com.bhaskar.corvasnotes.adapters.OperationRecyclerViewAdapter;
import com.bhaskar.corvasnotes.views.DrawingCanvas;
import com.bhaskar.corvasnotes.constant.Constant;
import com.bhaskar.corvasnotes.entities.SavePhotoUtil;
...
public class DrawingBoard extends AppCompatActivity implements View.OnClickListener,
    ...
    public void onClick(View v) {
        ...
        if (mPaintCanvas.getCurrentOperation() != Constant.OPERATION_ERASE) {
            ...
            if (mPaintCanvas.getCurrentOperation() == Constant.OPERATION_FILL_VIEW)
    ...
    public void getPosition(int position) {
        ...
        switch (position) {
            case Constant.OPERATION_DRAW_PENCIL:
                mPaintCanvas.setCurrentOperation(Constant.OPERATION_DRAW_PENCIL);
                mPaintCanvas.changeFillStyle(Constant.PAINT_STYLE_STROKE);
                break;
            case Constant.OPERATION_ERASE:
                mPaintCanvas.setCurrentOperation(Constant.OPERATION_ERASE);
                break;
            case Constant.OPERATION_CLEAR_CANVAS:
                ...
                break;
            case Constant.OPERATION_UNDO:
                mPaintCanvas.undoPreviousOperation();
                break;
//            case Constant.OPERATION_REDO:
//                mPaintCanvas.redoPreviousOperation();
//                break;
            case Constant.OPERATION_CHOOSE_COLOR:
                openColorDrawer();
                break;
//            case Constant.OPERATION_DRAW_CIRCLE:
//                mPaintCanvas.setCurrentOperation(Constant.OPERATION_DRAW_CIRCLE);
//                mPaintCanvas.changeFillStyle(Constant.PAINT_STYLE_FILL);
//                drawCircleOnBoard();
//                break;
//            case Constant.OPERATION_DRAW_RECTANGLE:
//                mPaintCanvas.setCurrentOperation(Constant.OPERATION_DRAW_RECTANGLE);
//                mPaintCanvas.changeFillStyle(Constant.PAINT_STYLE_FILL);
//                drawRectangleOnBoard();
//                break;
//            case Constant.OPERATION_DRAW_OVAL:
//                mPaintCanvas.setCurrentOperation(Constant.OPERATION_DRAW_OVAL);
//                mPaintCanvas.changeFillStyle(Constant.PAINT_STYLE_FILL);
//                drawRectangleOnBoard();
//                break;
//            case Constant.OPERATION_INSERT_TEXT:
//                mPaintCanvas.setCurrentOperation(Constant.OPERATION_INSERT_TEXT);
//                getTextInputFromUser();
//                break;
            case Constant.OPERATION_SAVE_IMAGE:
...
/*
            case Constants.OPERATION_SAVE_IMAGE_TO_SERVER:
                ...
                break;
*/
//            case Constant.OPERATION_SET_BACKGROUND:
...
//        mBuilder = new AlertDialog.Builder(DrawingBoard.this);
//        if (mPaintCanvas.getCurrentOperation() == Constant.OPERATION_DRAW_RECTANGLE)
...
//    }
    ...
    public void loadImageFromGallery() {
        ...
        startActivityForResult(Intent.createChooser(intent, "Select Picture"),Constant.RESULT_LOAD_IMAGE);
    }
