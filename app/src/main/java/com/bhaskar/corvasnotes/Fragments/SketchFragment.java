package com.bhaskar.corvasnotes.Fragments;
...
import com.bhaskar.corvasnotes.databinding.FragmentSketchBinding;
import com.bhaskar.corvasnotes.listeners.OnDrawChangedListener;
import com.bhaskar.corvasnotes.views.AlphaManager;
import com.bhaskar.corvasnotes.views.SketchView;
...
public class SketchFragment extends Fragment implements OnDrawChangedListener{ /*implements OnDrawChangedListener*/
...
//            getMainActivity().getSupportActionBar().setTitle("Activity Sketch");
